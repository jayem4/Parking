...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 25, 2025 at 04:40 AM
...
CREATE TABLE `user` (
  ...
  `u_lnum` varchar(55) NOT NULL,
  `u_user` varchar(55) NOT NULL,
  `u_password` varchar(55) NOT NULL,
  `u_type` varchar(55) NOT NULL,
  `u_typeofvehicle` varchar(55) NOT NULL,
  `u_time` varchar(55) NOT NULL,
